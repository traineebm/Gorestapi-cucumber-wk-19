...
public class AllUsersCRUDTest extends TestBase {
    ...
    public void test002() {
        ...
        System.out.println(userId); //6607
    }

    @Title("Update the user information and verify the updated information for ID = 6607")
    @Test
    public void test003() {
    ...
    @Title("Delete the user and verify if the user is deleted! for ID = 6607")
    @Test
    public void test004() {
        userId = 6607;
